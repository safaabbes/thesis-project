...
def main():
    ...
    # Update path
    args.path_weigths = os.path.join('..', '..', 'data', 'exps', 'biased_models', args.exp)
    ...
    for args.do_norm in [False]:
        ...
        for filename in args.filenames:
            ...
            if args.do_norm:
                ...
                fn = '{:s}_2D_{:s}_bias.png'.format(filename, args.viz)
            ...
            if args.do_norm:
                ...
                fn = '{:s}_3D_{:s}_bias.png'.format(filename, args.viz)
